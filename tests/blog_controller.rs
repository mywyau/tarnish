...
//     use tarnish::controllers::blog_controller::{create_post, get_by_post_id, update_post};
//     use tarnish::schemas::blog_schema::posts;
//     use tarnish::{delete_post, NewPost};
//
...
//             .execute(&mut conn)
//             .expect("Failed to reset ID sequence");
//         // e.g., setup database, environment variables, etc.
//     }
//
//     struct TestGuard {
//         pool: web::Data<DbPool>,
//         post_ids: Vec<String>,
//         post_ids_to_delete: Vec<String>,
//     }
//
//     impl TestGuard {
...
//             let post_ids: Vec<String> = posts_to_insert.into_iter().map(|p| p.post_id).collect();
//             let post_ids_to_delete: Vec<String> = vec![];
//
//
//             TestGuard { pool, post_ids, post_ids_to_delete }
//         }
//     }
//
...
//         // Initialize the app or any shared setup
//         let mut app =
//             test::init_service(
//                 App::new()
//                     .service(get_by_post_id)
...
//
//         // Run the first test
//         get_by_post_id_test::test_get_by_post_id(&mut app).await;
//
//         update_post_test::test_update_post(&mut app).await;
//         // Run the second test
//         create_post_tests::test_create_post(&mut app).await;
//
//         // Run the final test
//         delete_post_tests::test_delete_post(&mut app).await;
//     }
// }